...
public class CCGradientColor {
    ...
    public static CCGradientColor fromSaveString(String string) {
        CCGradientColor newColor = new CCGradientColor();
        int index = 0;
    ...
    public void loadFromCCColor(CCGradientColor otherColor) {
    ...
    public boolean equals(Object o) {
        ...
        CCGradientColor other = (CCGradientColor) o;
