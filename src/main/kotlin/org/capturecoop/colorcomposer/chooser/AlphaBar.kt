...
import org.capturecoop.defaultdepot.FileUtils
...
class AlphaBar(private var backgroundColor: Color, private val direction: BarDirection, alwaysGrab: Boolean) : JPanel() {
    ...
    init {
        ...
        gridImage = FileUtils.getInternalInputStream("/org/capturecoop/colorcomposer/transparent_grid_4x4.png").use { ImageIO.read(it) }
    ...
    private fun execute(x: Int, y: Int) {
        ...
        alpha = Vector2F(percentage / 100f, 0.0f).limitX(0f, 1f).x
        repaint()
    ...
    override fun paint(g: Graphics) {
        ...
        if (dirty) {
            ...
            bufferGraphics.drawImage(ColorUtils.createAlphaBar(backgroundColor, sizeX, sizeY, direction), MARGIN / 2, MARGIN / 2, sizeX, sizeY, this)
